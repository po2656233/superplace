...
// #67 panic() on exing slices (decodeSlice with disabled ZeroValues)
...
// GH-140 Type error when using DecodeHook to decode into facade
...
// #103 Check for base type before trying to access its composants prevent a panic error
// in decodeSlice
